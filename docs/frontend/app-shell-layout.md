...
- 2026-09-17 · main session · the nav now has six tabs (`analyze`, `history`, `library`, `account`, `api-key`, `releases`); the "four" mentions above predate this — see `library-panel.md` and `account-panel.md`
